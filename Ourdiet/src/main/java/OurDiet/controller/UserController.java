...
public class UserController {
	@Autowired
	private UserService memberRegisterService;
	@RequestMapping( {"/", "/main"} )
	...
	public String register_request(@RequestParam(value="ConfirmPwd", required=true) String ConfirmPwd, Member _member, RedirectAttributes red) {
		try {
